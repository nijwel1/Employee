...
@section('header', 'Department Trash')
@section('content')
    @push('css')
    @endpush
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex justify-content-end mb-3">
                            <button type="button" id="deleteAllBtn" disabled class="btn btn-sm btn-danger me-2"> <i
                                ...
                                Delete</button>
                            <a href="{{ route('department.index') }}" class="btn btn-sm btn-base"><i
                            ...
                            <table id="" class="table table-hover table-responsive">
                                ...
                                <tbody>
                                    @forelse ($departments as $key => $department)
                                        <tr>
                                            <td width="5%">
                                                <form id="deleteAllForm" action="{{ route('department.delete.all') }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                            ...
                                            <td width="10%">
                                                <div class="d-flex gap-1">
                                                    <form action="{{ route('department.restore', $department->id) }}"
                                                        method="get">
                                                    ...
                                                    <form action="{{ route('department.forceDelete', $department->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
