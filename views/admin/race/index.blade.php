                    ...
                    <div class="col-lg-6">
                        <div class="">
                            <div class="d-flex justify-content-end mb-3">
                                <a href="{{ route('race.trash') }}" class="btn btn-danger btn-sm me-2"> <i
                                            ...
                                            <td width="10%">
                                                <div class="d-flex gap-1">
                                                    <button class="btn btn-outline-base btn-sm edit"
                                                        data-id="{{ $race->id }}" data-bs-toggle="modal"
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('race.store') }}" method="POST">
                                            @csrf
                                            <div class="mb-3">
                                                <label for="input1" class="form-label">Race</label>
                                                <input type="text" name="name" class="form-control" id="input1"
                                                    placeholder="Race Name" required />
                                            </div>
                                            <div class="mb-3">
